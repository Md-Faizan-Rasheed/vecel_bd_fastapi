...
if not OPENAI_API_URL:
    raise RuntimeError("❌ Missing OPENAI_API_URL in environment variables")
...
# ======================================
# Job Details Endpoint (FIXED)
# ======================================
@app.get("/jobs/{_id}", response_model=JobResponse, summary="Fetch Job Details by ID")
async def get_job_details(_id: str):
    try:
        object_id = ObjectId(_id)
    except InvalidId:
